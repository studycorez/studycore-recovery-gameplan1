    ...
    <Document>
      <Page size="LETTER" style={styles.page}>
        ...
        <Section number={2} title="SERVICES & OBLIGATIONS">
          ...
          <Bullet>Reschedule sessions with at least 24 hours notice. Tutor may reschedule a maximum of 2 sessions per student per calendar month. A third reschedule in the same calendar month counts as 1 strike.</Bullet>
        </Section>
