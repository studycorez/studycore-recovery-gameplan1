              ...
              {wg.sessions.map((sess, si) => {
                ...
                return (
                  <React.Fragment key={si}>
                    {sess.isCheckpoint && (
                      <View style={s.checkpointBanner}>
                        <Text style={s.checkpointBannerText}>▶ CHECKPOINT — Take a Full-Length Practice Test before Session {sess.session} · bring your score report to review together</Text>
                      </View>
                    )}
