    ...
    <Document>
      <Page size="LETTER" style={styles.page}>
        ...
        <Section number={6} title="PERFORMANCE GUARANTEE OBLIGATION">
          ...
          <Text style={styles.paragraph}>
            If Tutor is no longer engaged with StudyCore at the time the guarantee is triggered, this obligation does not apply and StudyCore will assign a replacement tutor.
          </Text>
        </Section>
