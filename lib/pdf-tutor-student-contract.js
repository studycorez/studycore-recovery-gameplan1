    ...
    <Document>
      <Page size="LETTER" style={styles.page}>
        ...
        <Section number={5} title="PAYMENT FOR THIS ASSIGNMENT">
          ...
          <Text style={styles.paragraph}>
            <Text style={styles.bold}>Performance Bonus & Rate Progression: </Text>If {studentName || 'Student'} achieves their target score of {targetScore || '—'} on the first official SAT taken after completing the program, Tutor will receive a one-time cash bonus of $200.00 and will advance to the next rate tier per the Rate Progression schedule in the General Tutor Services Agreement. Both the bonus and rate increase take effect the pay period following official score confirmation.
          </Text>
          <Text style={styles.paragraph}>
        ...
        <Section number={6} title="PERFORMANCE GUARANTEE OBLIGATION">
          ...
          <Text style={styles.paragraph}>
            If {studentName || 'Student'} triggers this guarantee and Tutor remains actively engaged with StudyCore, Tutor is required to continue delivering sessions to {studentName || 'Student'} beyond the original program End Date until {studentName || 'Student'} achieves their target score of {targetScore || '—'} on an official SAT. StudyCore will compensate Tutor at the standard rate ($20.00/hour) for all sessions delivered during the guarantee period. This obligation is a continuation of the current assignment and does not require a new contract.
          </Text>
          <Text style={styles.paragraph}>
