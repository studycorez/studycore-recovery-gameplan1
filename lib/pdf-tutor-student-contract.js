    ...
    <Document>
      <Page size="LETTER" style={styles.page}>
        ...
        <Section number={5} title="PAYMENT FOR THIS ASSIGNMENT">
          ...
          <Text style={styles.paragraph}>
            <Text style={styles.bold}>Performance Bonus & Rate Progression: </Text>The $200.00 is a fixed cost to StudyCore for this assignment. If {studentName || 'Student'} achieves their target score of {targetScore || '—'} on the first official SAT taken after completing the program, the $200.00 is paid to Tutor as a performance bonus, and Tutor advances to the next rate tier per the Rate Progression schedule in the General Tutor Services Agreement. Both the bonus and rate increase take effect the pay period following official score confirmation. If the performance guarantee is triggered (see Section 6), the $200.00 is instead allocated to fund the guarantee session period and Tutor forfeits the bonus for this assignment.
          </Text>
          <Text style={styles.paragraph}>
        ...
        <Section number={6} title="PERFORMANCE GUARANTEE OBLIGATION">
          ...
          <Text style={styles.paragraph}>
            If {studentName || 'Student'} triggers this guarantee and Tutor remains actively engaged with StudyCore, Tutor is required to continue delivering sessions to {studentName || 'Student'} beyond the original program End Date. StudyCore will compensate Tutor at the standard rate ($20.00/hour) for all sessions delivered during the guarantee period, funded by the $200.00 guarantee allocation described in Section 5. This obligation is a continuation of the current assignment and does not require a new contract.
          </Text>
          <Text style={styles.paragraph}>
            <Text style={styles.bold}>Guarantee Session Cap: </Text>Tutor's obligation under this guarantee is capped at ten (10) additional sessions. After ten sessions have been delivered beyond the original program End Date, Tutor's guarantee obligation ends regardless of whether {studentName || 'Student'} has achieved their target score. StudyCore will determine next steps for the student independently.
          </Text>
          <Text style={styles.paragraph}>
