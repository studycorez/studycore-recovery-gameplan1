    ...
    <Document>
      <Page size="LETTER" style={styles.page}>
        ...
        <Section number={5} title="PAYMENT FOR THIS ASSIGNMENT">
          ...
          <Text style={styles.paragraph}>
            <Text style={styles.bold}>Performance Bonus: </Text>If {studentName || 'Student'} achieves their target score of {targetScore || '—'} on the first official SAT taken after completing the program, Tutor will receive a one-time bonus of $50.00, paid in the following pay period. This bonus reflects Tutor's contribution to the student's success.
          </Text>
          <Text style={styles.paragraph}>
