    ...
    <Document>
      <Page size="LETTER" style={styles.page}>
        ...
        <Section number={6} title={`PERFORMANCE GUARANTEE — WE WORK WITH YOU FREE UNTIL YOU HIT YOUR SCORE`}>
          <Text style={styles.paragraph}>
            If Student completes all {totalHours} 1-on-1 sessions included in this Agreement, remains Engaged (as defined below) throughout the program, completes all assigned homework and practice materials, fully upholds all Client Responsibilities set out in Section 07, and does not achieve a score of {targetScore} or higher on the Target SAT Test ({targetTestDate}), StudyCore will continue working with Student at no additional cost — through continued 1-on-1 tutoring sessions and office hours — until Student achieves a score of {targetScore} or higher on a subsequent official SAT.
          </Text>
          <Text style={styles.paragraph}>
        ...
        <Section number={7} title="CLIENT RESPONSIBILITIES">
          ...
          <Bullet>Complete 100% of assigned homework, practice tests, and drill sets between sessions</Bullet>
        ...
        <View style={styles.signaturesSection}>
          ...
          <View style={styles.signatureBlock}>
            ...
            <Text style={styles.signatureLabel}>StudyCore LLC Representative (Neil Shah)</Text>
